...
w_values = [0.2]
c1_values = [2.0, 2.5, 3.0]
c2_values = [2.5, 3.0]
num_particles_values = [50]
results = []
        ...
        for c2 in c2_values:
            ...
            for num_particles in num_particles_values:
                ...
                for run in range(num_runs):
                    pso_optimizer = PSOOptimizer(ackley_function.evaluate, dimensions=2, w=w, c1=c1, c2=c2, num_particles=num_particles)
